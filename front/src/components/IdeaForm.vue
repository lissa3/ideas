<template>
 ...
 <!-- form                   -->
          <b-form
                ...
                novalidate > 
<!-- extra comp categories                          -->
                <app-categ-input
                    :setCategNames="initialValues.categs"
...
import tagsHelp from '@/assets/js/tagsHelper'
import optimizePhoto from '@/assets/js/resizeUtil.js'
...
export default {
    ...
    data(){
        return {
            ...
            // upload file
            checked: false, 
            browserFileUploadMsg:'',
            localErr:false,
            alertHeavyFile:false,
    ...
    methods:{
        ...
        clearCheckboxUploadFile(){
          console.log("file checkbox upload ?")
        },
        detachFile(){
          console.log("detaching a file")
        }
    }    
}
</script>
